    ...
    <section className="pt-20 md:pt-32 flex flex-col items-start max-w-4xl">
      ...
      >
        {headlineLines.map((line, i) => (
          <span key={i}>
            <span className={i === 1 ? 'text-gray-500' : 'text-white'}>
              {line}
            </span>
      ...
      <motion.p
        ...
        className="text-base text-gray-400 font-normal mb-6"
      >
        {t.tagline}
      </motion.p>
      ...
      >
        ...
        <a
          ...
          className="relative text-gray-400 text-sm font-medium hover:text-white transition-colors after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-white after:transition-all hover:after:w-full"
        >
          {t.ctaSecondary}
        </a>
      </motion.div>
          ...
          <>
            ...
            >
              <div className="border-l border-gray-800 pl-3">
                ...
                <p className="text-gray-500 text-sm leading-snug mt-0.5 max-w-[200px]">{item.detail}</p>
              </div>
            </motion.div>
            {i < t.differentiators.length - 1 && (
              <motion.span
                ...
                className="hidden sm:flex items-start pt-0.5 pr-8 text-gray-700 text-sm select-none"
                aria-hidden="true"
              >
                ·
              </motion.span>
