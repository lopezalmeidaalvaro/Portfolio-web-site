    ...
    <section id="projects" className="py-20 scroll-mt-24">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <motion.div 
          ...
          className="group relative md:col-span-2 lg:col-span-3 rounded-3xl bg-gray-900 border border-gray-800 p-8 hover:bg-gray-800/50 transition-colors flex flex-col md:flex-row justify-between md:items-end gap-8 overflow-hidden"
        >
          <div className="absolute top-0 right-0 p-8 opacity-0 group-hover:opacity-100 transition-opacity">
